...
export const simgeler: Record<SimgeAdi, string> = {
  ...
  konumIsareti: `
    ...
    <circle cx="12" cy="9.2" r="2.6" fill="#0a0c0b" />
  `,
  telefonIz: `
    <rect x="7" y="2" width="10" height="17" rx="2.4" />
    <rect x="9.4" y="18.4" width="5.2" height="3.6" rx="1.2" fill="#0a0c0b" />
    <circle cx="12" cy="5.4" r="1" fill="#0a0c0b" />
  `,
  zamanCizgisi: `
  ...
  dosyaAktar: `
    ...
    <path d="M14 2v4h4" fill="#0a0c0b" opacity="0.5" />
    <path d="M12 10v7m0 0-2.8-2.8M12 17l2.8-2.8" stroke="#0a0c0b" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round" />
  `,
  korumaKalkani: `
    <path d="M12 2 20 5.4v6c0 5.4-3.6 9-8 10.6-4.4-1.6-8-5.2-8-10.6v-6Z" />
    <path d="M8.6 12.1 11 14.5 15.6 9.6" stroke="#0a0c0b" stroke-width="1.9" fill="none" stroke-linecap="round" stroke-linejoin="round" />
  `,
  yildirimHiz: `
  ...
  onayRozeti: `
    ...
    <path d="M8.6 12.3 10.8 14.5 15.4 9.5" stroke="#0a0c0b" stroke-width="1.9" fill="none" stroke-linecap="round" stroke-linejoin="round" />
  `,
  aramaMercek: `
    <circle cx="10.5" cy="10.5" r="7.5" />
    <circle cx="10.5" cy="10.5" r="4.2" fill="#0a0c0b" opacity="0.55" />
